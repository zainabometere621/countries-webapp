...
//         Explore 18 countries from around the world
//       </p>

//       <section className="grid grid-cols-4 gap-4 max-w-6xl mx-auto my-6">
//         {countries.map((c) => (
//           <div className="p-2 border bg-blue-100 border-gray-200 text-md">
//             <p>{c.name}</p>
//             <p>{c.abbreviation}</p>
//             <p>{c.flag}</p>
//             {/* <p>{c.w}</p> */}
            ...
            >
              ...
              <div className="space-y-4 pt-4">
                <div className="flex justify-between">
                  <p className="font-semibold text-lg">{c.name.common} ({c.cca2})</p>
                  <p>{c.capital}</p>
                </div>
                <div className="flex items-center gap-2 ">
                  <UserPlus className="text-gray-400"/>
                  <p className="font-semibold"><span className="text-gray-400 font-extralight text-base">Population: </span>{c.population}</p>
                </div>
              </div>
            </div>
          ))}
